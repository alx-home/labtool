...
template<typename T>
void ComputeGaussianKernel(const vnl_matrix<T>& model, const vnl_matrix<T>& ctrl_pts, vnl_matrix<T>& G, vnl_matrix<T>& K, T beta);
...
template<typename T>
void ComputeP(const vnl_matrix<T>& x, const vnl_matrix<T>& y, vnl_matrix<T>& P, T &E, T sigma, int outliers, bool constrained,
		const vnl_matrix<T>& PC);
