...
class vnl_numeric_traits<bool>
{
 public:
  //: Additive identity
  static constexpr bool zero VCL_STATIC_CONST_INIT_INT_DECL(false);
  //: Multiplicative identity
  static constexpr bool one VCL_STATIC_CONST_INIT_INT_DECL(true);
  //: Maximum value which this type can assume
  static constexpr bool maxval VCL_STATIC_CONST_INIT_INT_DECL(true);
  //: Return value of abs()
...
class vnl_numeric_traits<char>
{
 public:
  //: Additive identity
  static constexpr char zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr char one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume.
  //  It is 127 (and not 255) since "char" is not guaranteed to be unsigned.
#ifdef _MSC_VER
#ifdef _CHAR_UNSIGNED
  static constexpr char maxval VCL_STATIC_CONST_INIT_INT_DECL(255);
#else
  static constexpr char maxval VCL_STATIC_CONST_INIT_INT_DECL(127);
#endif
#else
  static constexpr char maxval VCL_STATIC_CONST_INIT_INT_DECL(char(255)<0?127:255);
#endif
  //: Return value of abs()
...
class vnl_numeric_traits<unsigned char>
{
 public:
  //: Additive identity
  static constexpr unsigned char zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr unsigned char one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
  static constexpr unsigned char maxval VCL_STATIC_CONST_INIT_INT_DECL(255);
  //: Return value of abs()
  typedef unsigned char abs_t;
  //: Name of a type twice as long as this one for accumulators and products.
...
class vnl_numeric_traits<signed char>
{
 public:
  //: Additive identity
  static constexpr signed char zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr signed char one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
  static constexpr signed char maxval VCL_STATIC_CONST_INIT_INT_DECL(127);
  //: Return value of abs()
  typedef unsigned char abs_t;
  //: Name of a type twice as long as this one for accumulators and products.
...
class vnl_numeric_traits<short>
{
 public:
  //: Additive identity
  static constexpr short zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr short one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<unsigned short>
{
 public:
  //: Additive identity
  static constexpr unsigned short zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr unsigned short one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<int>
{
 public:
  //: Additive identity
  static constexpr int zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr int one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<unsigned int>
{
 public:
  //: Additive identity
  static constexpr unsigned int zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr unsigned int one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<long>
{
 public:
  //: Additive identity
  static constexpr long zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr long one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<unsigned long>
{
 public:
  //: Additive identity
  static constexpr unsigned long zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr unsigned long one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits<size_t>
{
 public:
  //: Additive identity
  static constexpr size_t zero VCL_STATIC_CONST_INIT_INT_DECL(0);
  //: Multiplicative identity
  static constexpr size_t one VCL_STATIC_CONST_INIT_INT_DECL(1);
  //: Maximum value which this type can assume
...
class vnl_numeric_traits< vcl_complex<float> >
{
 public:
  ...
  //static constexpr vcl_complex<float> maxval;
...
class vnl_numeric_traits< vcl_complex<double> >
{
 public:
  ...
  // Maximum value which this type can assume; makes no sense for this type
  //static constexpr vcl_complex<double> maxval;
...
class vnl_numeric_traits< vcl_complex<long double> >
{
 public:
  ...
  // Maximum value which this type can assume; makes no sense for this type
  //static constexpr vcl_complex<long double> maxval;
