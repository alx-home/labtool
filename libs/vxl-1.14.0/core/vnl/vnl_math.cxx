...
//: constants
constexpr double vnl_math::e VCL_STATIC_CONST_INIT_FLOAT_DEFN( 2.71828182845904523540 );
constexpr double vnl_math::log2e VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.44269504088896340740 );
constexpr double vnl_math::log10e VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.43429448190325182765 );
constexpr double vnl_math::ln2 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.69314718055994530942 );
constexpr double vnl_math::ln10 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 2.30258509299404568402 );
constexpr double vnl_math::pi VCL_STATIC_CONST_INIT_FLOAT_DEFN( 3.14159265358979323846 );
constexpr double vnl_math::pi_over_2 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.57079632679489661923 );
constexpr double vnl_math::pi_over_4 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.78539816339744830962 );
constexpr double vnl_math::one_over_pi VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.31830988618379067154 );
constexpr double vnl_math::two_over_pi VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.63661977236758134308 );
constexpr double vnl_math::two_over_sqrtpi VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.12837916709551257390 );
constexpr double vnl_math::one_over_sqrt2pi VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.39894228040143267794 );
constexpr double vnl_math::sqrt2 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.41421356237309504880 );
constexpr double vnl_math::sqrt1_2 VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.70710678118654752440 );
constexpr double vnl_math::euler VCL_STATIC_CONST_INIT_FLOAT_DEFN( 0.57721566490153286061 );

//: IEEE double machine precision
constexpr double vnl_math::eps VCL_STATIC_CONST_INIT_FLOAT_DEFN( 2.2204460492503131e-16 );
constexpr double vnl_math::sqrteps VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.4901161193847660e-08 );

//: IEEE single machine precision
constexpr float vnl_math::float_eps VCL_STATIC_CONST_INIT_FLOAT_DEFN( 1.1920928960e-7f );
constexpr float vnl_math::float_sqrteps VCL_STATIC_CONST_INIT_FLOAT_DEFN( 3.4526698307e-4f );
...
bool vnl_math_isnan(float x) {
	return x != x;
} // causes "floating exception" on alpha & sgi
//: Return true iff x is "Not a Number"
...
# endif
# if VXL_BIG_ENDIAN
static constexpr int sz_f = 0;
static constexpr int sz_d = 0;
static constexpr int sz_l = 0;
# else
static constexpr int sz_f = sizeof(float)/sizeof(int) -1;
static constexpr int sz_d = sizeof(double)/sizeof(int) -1;
static constexpr int sz_l = sizeof(long double)/sizeof(int) -1;
# endif
...
//: Return true if x is neither NaN nor Inf.
bool vnl_math_isfinite(long double x) {return std::isfinite(x) != 0 && !_isnanl(x);}
