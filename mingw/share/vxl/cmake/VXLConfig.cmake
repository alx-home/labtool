...
# C:/workspace/libs/vxl-1.14.0/build/config/cmake/export/VXLConfig.cmake
#
...
SET(VXL_BUILD_SETTINGS_FILE "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/share/vxl/cmake/VXLBuildSettings.cmake")

# The VXL library dependencies.
IF(NOT VXL_NO_LIBRARY_DEPENDS)
  INCLUDE("C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/share/vxl/cmake/VXLLibraryDepends.cmake")
ENDIF(NOT VXL_NO_LIBRARY_DEPENDS)

# The VXL library directory.
SET(VXL_LIBRARY_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/lib")

# The VXL CMake support directory.
# Clients projects should not use the Find*.cmake files in this directory.
SET(VXL_CMAKE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/share/vxl/cmake")
...
SET(VXL_VCL_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/vcl")
SET(VXL_VCL_LIBRARIES "vcl")

SET(VXL_CORE_FOUND "YES" ) # VXL core is always FOUND.  It is not optional.
SET(VXL_CORE_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/core")
# VXL core has many libraries

SET(VXL_CORE_VIDEO_FOUND "NO" )
SET(VXL_CORE_VIDEO_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/core")
...
SET(VXL_BRL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/brl;C:/Program Files (x86)/vxl/include/vxl/contrib/brl/bbas;C:/Program Files (x86)/vxl/include/vxl/contrib/brl/bseg;C:/Program Files (x86)/vxl/include/vxl/contrib/brl/bvml")
...
SET(VXL_GEL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/gel")
# VXL GEL has many libraries

SET(VXL_MUL_FOUND "OFF")
SET(VXL_MUL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/mul")
# VXL MUL has many libraries

SET(VXL_OUL_FOUND "OFF")
SET(VXL_OUL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/oul")
# VXL OUL has many libraries

SET(VXL_OXL_FOUND "OFF")
SET(VXL_OXL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/oxl")
# VXL OXL has many libraries

SET(VXL_PRIP_FOUND "OFF")
SET(VXL_PRIP_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/prip")
# VXL PRIP has many libraries

SET(VXL_RPL_FOUND "OFF")
SET(VXL_RPL_RGTL_FOUND "OFF")
SET(VXL_RPL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/rpl")
# VXL RPL has many libraries

SET(VXL_TBL_FOUND "OFF")
SET(VXL_TBL_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/tbl")
# VXL TBL has many libraries

SET(VXL_CONVERSIONS_FOUND "OFF")
SET(VXL_CONVERSIONS_INCLUDE_DIR "C:/Program Files (x86)/vxl/include/vxl/contrib/conversions")
...
SET(VXL_NETLIB_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/netlib")
SET(VXL_NETLIB_LIBRARIES "netlib;v3p_netlib")

SET(VXL_QV_FOUND "YES")
SET(VXL_QV_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p")
SET(VXL_QV_LIBRARIES "Qv")

SET(VXL_ZLIB_FOUND "YES")
SET(VXL_ZLIB_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/zlib")
SET(VXL_ZLIB_LIBRARIES "z")

SET(VXL_PNG_FOUND "YES")
SET(VXL_PNG_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/png;C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/zlib")
SET(VXL_PNG_LIBRARIES "png")

SET(VXL_JPEG_FOUND "YES")
SET(VXL_JPEG_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/jpeg")
...
SET(VXL_MPEG2_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/mpeg2/include;C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/v3p/mpeg2/include/mpeg2dec")
...
SET(VXL_EXPAT_INCLUDE_DIR "C:/mingw-w64/x86_64-4.9.2-posix-seh-rt_v3-rev1/mingw64/include/vxl/contrib/brl/b3p/expat")
...
SET(VXL_V3P_INCLUDE_DIR_deprecated "C:/Program Files (x86)/vxl/include/vxl/v3p")
