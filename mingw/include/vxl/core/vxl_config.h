...
#define VXL_UNISTD_HAS_UALARM     0
#define VXL_UNISTD_HAS_USLEEP     1
#define VXL_UNISTD_HAS_LCHOWN     0
#define VXL_UNISTD_HAS_PREAD      0
#define VXL_UNISTD_HAS_PWRITE     0
...
#define VXL_HAS_MINGW_ALIGNED_MALLOC 1
